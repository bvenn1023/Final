...
if (isset($_GET["getid"])) {
	...
	if(isset($_POST["email"])&&isset($_POST["password"])&&isset($_POST["role"])){
		...
		editData($_GET["getid"],$_POST["email"],$_POST["password"],$_POST["role"]);
	}
} else {
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
								...
								<input type="text" id="email" name="email" value="<?php getData('email');?>"  required><br><br>

								<label for="description">Password:</label><br>
								<input type="Password" id="password" name="password" value="<?php getData('password');?>"  required><br><br>
													
								<label for="admin">Admin status: </label>
								value of 1 means admin, 0 means user
								<input type="text" id="role" name="role" value="<?php getData('role')?>"  required><br><br>
