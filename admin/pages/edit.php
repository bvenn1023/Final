            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php">Edit Pages</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                            ...
                            <form method="POST">
								<label for="newContent">File Contents:</label><br>
								<textarea id="newContent" name="newContent" style="width: 50%;" rows="20" required>
								  <?php echo htmlspecialchars(file_get_contents($_GET["name"]));?>
								</textarea>
